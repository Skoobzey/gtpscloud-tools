      ...
      <div className="w-full max-w-md mx-auto px-6">
        ...
        <div className="bg-[#111111] border border-[#27272a] rounded-2xl p-8">
          ...
          <p className="text-[#a1a1aa] text-sm mb-8">
            Authenticate with your Discord account to access the tools dashboard.
          </p>

          <button
            onClick={() => signIn.social({ provider: 'discord', callbackURL: '/dashboard' })}
            disabled={isPending}
            className="w-full flex items-center justify-center gap-3 bg-[#5865F2] hover:bg-[#4752c4] disabled:opacity-50 disabled:cursor-not-allowed text-white font-semibold py-3 px-6 rounded-xl transition-colors duration-150"
          >
        ...
        <p className="text-center text-[#52525b] text-xs mt-6">
          Access is restricted to authorised GTPS Cloud staff.
        </p>
      </div>
    </main>
  );
